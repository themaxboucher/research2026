...
# Llama 3.1 8b (https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct): December 2023
...
# Qwen 2.5 7b (https://huggingface.co/Qwen/Qwen2.5-7B-Instruct): Unknown, but we know the model was released on September 18, 2024 (https://qwen.ai/blog?id=qwen2.5)
