...
BASELINE_SOFTWARE_MODEL = "<baseline-software>"
...
BASELINE_MODELS = frozenset(
    {BASELINE_SOFTWARE_MODEL, BASELINE_GENERAL_MODEL, BASELINE_GIBBERISH_MODEL}
)
...
BASELINES = (
    (BASELINE_SOFTWARE_MODEL, SOFTWARE_SENTENCES),
    (BASELINE_GENERAL_MODEL, GENERAL_SENTENCES),
    (BASELINE_GIBBERISH_MODEL, GIBBERISH_SENTENCES),
)
